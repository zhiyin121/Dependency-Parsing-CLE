...
trainset.load('english/train/wsj_train.conll06')

testset = dataset.Dataset(dic_form, dic_pos, dic_label)
testset.load('english/dev/wsj_dev.conll06.gold', training=False)

pickle.dump({
    'dic_form': dic_form,
    'dic_pos': dic_pos,
    'dic_label': dic_label
}, open('dictionary.pkl', 'wb'))
...
for epoch in range(10):
    ...
    for batch_ndx, sample in enumerate(train_loader):
        ...
        if batch_ndx % 10 == 0:
            ...
            loss_record = 0.0
            json.dump(record, open('en_record.json', 'w'), indent=2)
            # break
    ...
    if uas_scores > best:
        ...
        best = uas_scores
    json.dump(score_record, open('en_record_score.json', 'w'), indent=2)
