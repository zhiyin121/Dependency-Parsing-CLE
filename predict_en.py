...
testset.load('english/dev/wsj_dev.conll06.blind', training=False)
...
model = torch.load(open('model.pt', 'rb'), map_location=device)
...
sentences = tools.reader('english/dev/wsj_dev.conll06.blind')
...
tools.writer('english/dev/wsj_dev.conll06.pred', sentences)